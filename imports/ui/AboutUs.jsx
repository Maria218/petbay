    ...
    return(
      <div>
        ...
        <div className="header-img">
          <img src="/images/aboutUsCat.jpg" />
          <h1 id="adopt">About the Team</h1>
        </div>
        <div className="container" style={{marginTop:20+"px"}}>
          <div className="row justify-content-center">
            <div className="col-md-8">
              <h2 className="aboutUs" style={{textAlign:"center"}}>We Are Pet Lovers Trying To Make A Difference</h2><br/>
          ...
          <div className="row justify-content-center">
            <div className="col-md-8">
              <h1 className="aboutUs" style={{textAlign:"center"}}>Meet our Developer Team</h1><br/>
              <p>We are a talented team of Emerging Developers with complementary skill sets. In our team you can find  developers,designers, data architects, system administrators and admin stuff.</p>
              <p>Due to the strong technical background which is in the heart of our team,  All web can practically take over and deliver any technical challenge, ranging from the development of simple web applications to highly demanding web tools, while the team members have the knowledge and business thinking to identify and utilize the value that is generated through the technical capabilities that are provided by existing or newly developed software.</p>
            </div>
          </div>
