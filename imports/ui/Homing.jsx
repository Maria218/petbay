          ...
          <div className="row justify-content-center">
            ...
            <div className="col-md-8" className="spc">
              <div className="text-center">
                <h4 style={{fontFamily: "Dosis"}}>Sign Up To Continue</h4>
              </div>
              <div className="text-center">
               <h5 style={{fontFamily: "Courgette"}}>Already have have an account? Please login <a href="" onClick={this.goToLogin}><strong>here</strong></a></h5>
             </div>
             <br />
              <form onSubmit = {this.getUserData} className="needs-validation">
                <div className="form-group">
                  <label className="col-form-label" style={{fontFamily: "Cagliostro", fontSize: 18 + "px"}} htmlFor="formGroupExampleInput">Individual or Organization Name</label>
                ...
                <div className="form-group">
                    <label className="col-form-label" style={{fontFamily: "Cagliostro", fontSize: 18 + "px"}} htmlFor="formGroupExampleInput2">Email Address</label>
                  ...
                  <div className="form-group">
                    <label className="col-form-label" style={{fontFamily: "Cagliostro", fontSize: 18 + "px"}} htmlFor="formGroupExampleInput2">Contact Number</label>
                  ...
                  <div className="form-group">
                    <label className="col-form-label" style={{fontFamily: "Cagliostro", fontSize: 18 + "px"}} htmlFor="formGroupExampleInput2">Password</label>
                  ...
                  <div className="form-group">
                    <label className="col-form-label" style={{fontFamily: "Cagliostro", fontSize: 18 + "px"}} htmlFor="formGroupExampleInput2">Confirm Password</label>
                  ...
                  <div className="form-group">
                    <label className="col-form-label" style={{fontFamily: "Cagliostro", fontSize: 18 + "px"}} htmlFor="formGroupExampleInput2">Location</label>
                  ...
                  <div className="text-center">
                    <p><strong>*NOTE: The information on this form will be used as a contact reference for anyone wanting<br /> to buy from you. Please, put correct information about yourself</strong></p>
                  </div>
                  <div className="text-center">
