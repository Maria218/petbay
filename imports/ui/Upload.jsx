    ...
    return(
        ...
        <div className="row">
          ...
          <div className="col">
            ...
            <input onChange={this.handlePriceChange} type="number" className="form-control" name="price" maxlength="10" placeholder="Enter price in Kwacha" required/>
          </div>
        </div><br />
        <div className="row">
          ...
          <div className="col-md-6 form-group describe">
            ...
            <textarea onChange={this.handleDescriptionChange} className="form-control" id="exampleFormControlTextarea1" name="description" maxlength="100"  rows="5"></textarea>
          </div>
          <div className="col-md-3"></div>
        </div>
        <br />
